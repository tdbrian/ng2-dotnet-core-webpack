...
namespace Ng2Webpack
{
    ...
    /// </summary>
    public class Ng2WebpackOptions
    {

        public Ng2WebpackOptions(string entryPoint = "app/index.js", string outputFileName = "bundle.js", bool handleStyles = true)
        {
            EntryPoint = entryPoint;
            DevToolType = DevToolType.SourceMap;
            EnableES2015 = true;
            HandleStyles = handleStyles;
            DevServerOptions = new Ng2WebpackDevServerOptions();
        ...
        /// </summary>
        public Ng2WebpackDevServerOptions DevServerOptions { get; set; }
